...
module "endpoint-associations" {
  source                                = "./modules/endpoint-associations"
  ...
  DYNAMO_ENDPOINT_ID                    = "${module.vpc-endpoints.dynamo_endpoint_id}"
  S3_ENDPOINT_ID                        = "${module.vpc-endpoints.s3_endpoint_id}"
}
