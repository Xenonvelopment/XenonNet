/*
 XENON #################################################################################################################
       ...
       PARAMETERS:
        ...
        - CIDR Block: Address Range of Subnet
        - Availability Zone: Location of the subnet with regard to the data centre its address uses
        - Map Public IP On Launch: Give instances within subnet ability to have internet accessibility
        - Assign IPv6 Address On Creation: Give interfaces within subnet an public ip upon launch
 XENON #################################################################################################################
*/
